        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-center">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col xs:flex-row gap-3 sm:gap-4 justify-center md:justify-start">
              <Link href="/pricing" className="bg-[#2E1065] hover:bg-purple-800 text-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center space-x-2 text-sm sm:text-base">
                <img
              ...
              <Link href="/about" className="border-2 border-[#000000] text-purple-700 hover:bg-[#A78BFA] hover:text-white px-4 py-2.5 sm:px-6 sm:py-3 rounded-lg font-medium transition-colors duration-300 flex items-center justify-center space-x-2 text-sm sm:text-base">
                <img
